...
> **대학병원 인프라 엔지니어** · **데이터중심병원 연구원**이자 **EMR 시스템 개발자** 출신 엔지니어입니다.  
...
### 대학병원 의료정보과 — 인프라 운영 & 데이터중심병원 연구원
- **인프라 통합 관리**: 서버, 네트워크, DB 및 전산 시스템 전반 운영 및 유지관리
- **시스템 구축 & 인프라 아키텍처**: 원내 주요 시스템 구축, WAS 구축 및 Web-WAS 연동, 서버 이중화(HA) 기반 배포 구조 설계
- **데이터중심병원 연구원**: 의료 데이터 중심병원 지원사업 참여, 데이터 구축·활용 및 가명정보 관리
- **공공데이터 업무**: 병원 공공데이터 개방·관리, 데이터 연동 및 비식별화 데이터 관리
  
### 차세대 의료정보시스템(HIS/EMR) 구축 및 운영
- **차세대 의료정보시스템 구축 및 운영 경험** (전남대병원, 이화목동병원, 이화서울병원, 신촌세브란스, 강남세브란스, 경북대병원)
- **주요 세부 업무**
  - **처방**: 처방, DUR, 약물이상관리 등
  - **간호**: 병동, 외래, 행정, 주사실 등
  - **응급/외상센터**: 응급의료센터 및 권역외상센터 담당
  - **진료협력 시스템 개발**: 진료정보공유시스템 전면 재개발 및 의뢰·회송 업무 기능 개발
...
- 📊 **[Emergency Department Overcrowding Correlation Analysis](https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fraw.githubusercontent.com%2Fgatsjy%2Fgatsjy%2Fmain%2Fpresentations%2Fmedical-prediction-model.pptx)**: An AI-based real-time model that predicts emergency department crowding one hour ahead using clinical and operational data, with SHAP-based interpretability.
...
- ☕ **JAVA 기반 프론트엔드 전문 개발 과정** — 비트캠프 *(2018.02 ~ 2018.08)*
- 💻 **한국 HP UI/UX 엔지니어링 양성과정** — 한국휴렛앤팩커드(HP) *(2017.08 ~ 2017.11)*
- 🌏 **건양대학교 해외봉사단 활동** *(2016.10 ~ 2017.02)*
- 🏥 **천안단국대학교병원 원무과 실습** *(2016.07 ~ 2016.08)*
