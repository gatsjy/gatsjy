...
> **대학병원 인프라 엔지니어**이자 **EMR 시스템 개발자** 출신 엔지니어입니다.  
...
### 🏥 대학병원 전산실 — 인프라·시스템 운영 & 공공데이터
- **인프라 통합 관리**: 서버, 네트워크, DB 및 전산 시스템 전반 운영 및 유지관리
- **공공데이터 업무**: 병원 공공데이터 개방·관리, 데이터 연동 및 가명정보/비식별화 데이터 관리
...
- **Domain Skills**: HIS/EMR (처방, 간호, 응급, 약무), 공공데이터 관리, 시큐어 코딩, EMR 외부 인터페이스 연동
